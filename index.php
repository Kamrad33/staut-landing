                ...
                <div class="main-info main-content__background">
                    <div class="wrapper-main main-content__block">
                        <div id="main-image-slider" class="main-content__block__item main-content__block__item_double">
                            ...
                            <!-- <div id="main-image-slider" class="image-slider">
                                <div class="image-slider__img" style="background-image: url('./assets/images/sliderBack_1.png');"></div>
                                <div class="image-slider__img image-slider__img_front" style="background-image: url('./assets/images/sliderBack_1.png');">
                                    <div class="image-slider__button"></div></div>
                            </div> -->
                            <!-- <div id="main-image-slider" class="image-slider">
                                <div class="image-slider__img">
                                    <div class="image-slider__img__wrapper">
                                        <img src="./assets/images/sliderBack_1.png" alt="">
                                    </div>
                                </div>
                                <div class="image-slider__img image-slider__img_front">
                                    <div class="image-slider__img__wrapper">
                                        <img src="./assets/images/sliderBack_1.png" alt="">
                                    </div>
                                    <div class="image-slider__button"></div></div>
